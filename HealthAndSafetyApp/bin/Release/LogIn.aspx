        ...
        <asp:Login ID="LoginUser" runat="server" EnableViewState="false" RenderOuterTable="false">
            <LayoutTemplate>
                <div class="accountInfo">
                    <asp:Image ID="ApplicationLogo" runat="server" ImageUrl="~/ApplicationLogo.png" Height="235px" Width="235px" />
                    <h1>H&S Incident Manager</h1>
                    <h2>Log In</h2>
                    ...
                    <div class="submit-login">
                        ...
                        <asp:LinkButton ID="RegistrationLinkButton" runat="server" PostBackUrl="~/Register.aspx">Register for a demo account</asp:LinkButton>
                    </div>
